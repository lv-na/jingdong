$(function(){
	var heada=$(".head-a-a")[0]
 var head2=$(".head-2")[0];
 var headaa=$(".head-a-aa")[0];
 heada.onmouseover=function(){
   head2.style.display="block";
   headaa.style.display="block";
 }
 heada.onmouseout=function(){
   head2.style.display="none";
   headaa.style.display="none";
 }
	// banner 轮播
...
var over=getClass('over');
	...
	$('.head-a-b').on('mouseenter',function(){
		$(this).find('div').css('display','block')
		$('.head-a-b').on('mouseleave',function(){
			$(this).find('div').css('display','none')
		})
	})
})